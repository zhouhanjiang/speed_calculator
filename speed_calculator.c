...
void speed_calculator_update(speed_calculator_t* p_calc, unsigned long bytes, unsigned long current)
{
...
unsigned long speed_calculator_get_speed(speed_calculator_t* p_calc, unsigned long current)
{
	unsigned long idx = current & 0x1;
